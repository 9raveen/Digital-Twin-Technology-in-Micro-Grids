...
# Load model and data (cached to avoid reloading)
@st.cache_resource
def load_model_and_data():
    ...
    return model, feature_names, feature_means

model, feature_names, feature_means = load_model_and_data()
...
if st.button("📈 Load 24-Hour Profile Analysis (slow - click to analyze)"):
    ...
    with col_24_1:
        ...
        st.plotly_chart(fig_24_risk, use_container_width=True)
    ...
    with col_24_2:
        ...
        st.plotly_chart(fig_24_volt, use_container_width=True)
